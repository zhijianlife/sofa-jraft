...
public class PharosServer2 {

    public static void main(final String[] args) {

        final String dataPath = "/home/zhenchao/workspace/data/sofa/jraft/s2";
        ...
        node.addLeaderStateListener(new LeaderStateListener() {
            ...
            public void onLeaderStart(long leaderTerm) {
                System.out.println("[Pharos Server 2] Leader's ip is: " + ip + ", port: " + port);
                System.out.println("[Pharos Server 2] Leader start on term: " + leaderTerm);
            }

            @Override
            public void onLeaderStop(long leaderTerm) {
                System.out.println("[Pharos Server 2] Leader stop on term: " + leaderTerm);
            }
        });
        node.init(options);
    }
