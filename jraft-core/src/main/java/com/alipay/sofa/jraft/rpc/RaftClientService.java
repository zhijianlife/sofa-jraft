...
public interface RaftClientService extends ClientService {
     ...
     */
    Future<Message> preVote(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> requestVote(Endpoint endpoint,
                                RpcRequests.RequestVoteRequest request,
                                RpcResponseClosure<RpcRequests.RequestVoteResponse> done);
     ...
     */
    Future<Message> installSnapshot(Endpoint endpoint,
     ...
     * @return a future result
     */
    Future<Message> getFile(Endpoint endpoint,
     ...
     * @return a future result
     */
    Future<Message> timeoutNow(Endpoint endpoint,
     ...
     * @return a future result
     */
    Future<Message> readIndex(Endpoint endpoint,
