...
public class BoltRaftClientService extends AbstractBoltClientService implements RaftClientService {
    ...
    protected void configRpcClient(final RpcClient rpcClient) {
        rpcClient.addConnectionEventProcessor(ConnectionEventType.CONNECT, new ClientServiceConnectionEventProcessor(this.rgGroup));
    }
    ...
    @Override
    public Future<Message> preVote(final Endpoint endpoint,
    ...
    @Override
    public Future<Message> requestVote(final Endpoint endpoint,
                                       final RequestVoteRequest request,
                                       final RpcResponseClosure<RequestVoteResponse> done) {
        return this.invokeWithDone(endpoint, request, done, this.nodeOptions.getElectionTimeoutMs());
    }
    ...
    @Override
    public Future<Message> appendEntries(final Endpoint endpoint,
                                         final AppendEntriesRequest request,
                                         final int timeoutMs,
                                         final RpcResponseClosure<AppendEntriesResponse> done) {
    ...
    @Override
    public Future<Message> getFile(final Endpoint endpoint,
                                   final GetFileRequest request,
                                   final int timeoutMs,
    ...
    @Override
    public Future<Message> timeoutNow(final Endpoint endpoint,
                                      final TimeoutNowRequest request,
                                      final int timeoutMs,
    ...
    @Override
    public Future<Message> readIndex(final Endpoint endpoint,
