...
public interface CliClientService extends ClientService {
     ...
     */
    Future<Message> addPeer(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> removePeer(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> resetPeer(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> snapshot(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> changePeers(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> getLeader(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> transferLeader(Endpoint endpoint,
     ...
     * @return a future with result
     */
    Future<Message> getPeers(Endpoint endpoint,
